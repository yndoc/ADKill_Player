...
(function() {
	...
	YoukuAntiADs.prototype = {
        SITES: {
            ...
            'letv_c': {
                'player': refD + 'letv0225.swf',
                're': /http:\/\/.*letv[\w]*\.com\/.*cloud[^\.]*\.swf/i
            },
            'letvskin': {
...
/*            'kletv': {
                'player': refD + 'letvkernel.swf',
                're': /http:\/\/player\.letvcdn\.com\/p\/.*\/kletvplayer\.swf/i
            },
            'vletv': {
                'player': refD + 'letvviki3.swf',
                're': /http:\/\/player\.letvcdn\.com\/p\/.*\/V[\w]+player\.swf/i
            },
*/
            'pplive': {
            ...
            're': /http:\/\/(tv\.sohu\.com\/upload\/swf\/.*\d+|.*\/test\/player)\/(Main|playershell)\.swf/i
            },
            'pps': {
                'player':  refD +'pps.swf',
